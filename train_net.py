...
class Trainer(DefaultTrainer):
    """
    Extension of the Trainer class adapted to tvci.
    """
...
def setup(args):
    ...
    # Setup logger for "tvci" module
    setup_logger(output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="tvci")
    return cfg
